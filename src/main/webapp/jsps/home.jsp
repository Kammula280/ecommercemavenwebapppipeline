...
<h1 align="center"> This is a the java application to be used for demo purposes while practising devops methodologies. The build tool used is maven, application is running in tomcat server</h1>
<hr>
<br>
